...
console.log('------Object within an object, Arrays, Function ----------');
	...
	console.log(thatGuy.address.city + ',' + thatGuy.address.street);
...
// this is integrating multiple data types - object with an array of objects
	...
	console.log("James Bonds GPA is ",obj1.students[0].GPA);
	console.log("James Bonds GPA is ",obj1['students'][0]['GPA']);
/* ----------------------------------------------------------------------------
 STUDENT ACTIVITY 2:
...
----------------------------------------------------------------------------- */
	...
	var gradeAvg=function(student){
		var count=0;
		var total=0;
		for(i=0, j=student.students.length;i<j;i++){
			count++;
			total += student.students[i].GPA;
		};
		avg=total/count;
		return avg;
	};

	console.log(gradeAvg(obj1));
